...
private static Double func(String input,int i,int j){
        ...
        output[i][j]=sum(input.charAt(4)-48,input.charAt(6)-48,input.charAt(8)-48,input.charAt(10)-48);
        flag[i][j]=!flag[i][j];
        return output[i][j];
        }
        ...
        output[i][j]=avg(input.charAt(4)-48,input.charAt(6)-48,input.charAt(8)-48,input.charAt(10)-48);
        flag[i][j]=!flag[i][j];
        return output[i][j];
        }
        }else{
        ...
        output[i][j]=std(input.charAt(4)-48,input.charAt(6)-48,input.charAt(8)-48,input.charAt(10)-48);
        flag[i][j]=!flag[i][j];
        return output[i][j];
        }
        }
